...
{
    // Placeholder: no tests exist yet for en_nombre_del_rey; verify config exists at runtime
    const cfg = { id: 'en_nombre_del_rey', name: 'En Nombre del Rey' };
    assert(!!cfg, 'en_nombre_del_rey — config placeholder exists');
}
