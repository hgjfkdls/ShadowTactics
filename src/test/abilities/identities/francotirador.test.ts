...
console.log('\n--- Identity: Francotirador del Bosque ---\n');
...
function makeState(): GameState {
    ...
    s = {
        ...
        units: {
            ...
            gen1: { id: 'gen1', owner: 'p1', position: { q: -2, r: 0 }, attack: 4, hp: 20, difficulty: 6, range: 1, movementCost: 1, class: 'general', abilities: ['blanco_facil'] },
        },
    };
    return s;
}
...

{
    ...
    s = {
        ...s,
        players: {
            p1: { ...s.players['p1'], actionPoints: 10, cardsInHand: [], selectedIdentity: 'francotirador_1' },
            p2: { ...s.players['p2'], actionPoints: 5, cardsInHand: [] },
        },
        units: {
            ...s.units,
            gen1: { ...s.units['gen1'], class: 'archer', abilities: ['blanco_facil'], range: 3, position: { q: 1, r: 0 } },
            en: { ...s.units['en'], position: { q: 4, r: 0 }, didMovePreviousTurn: false },
        },
    };
