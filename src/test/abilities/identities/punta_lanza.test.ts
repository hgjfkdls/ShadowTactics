...
{
    // Placeholder: no tests exist yet for torbellino; verify config exists at runtime
    const cfg = { id: 'torbellino', name: 'Torbellino' };
    assert(!!cfg, 'torbellino — config placeholder exists');
}
