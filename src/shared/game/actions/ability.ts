...
function handlePosicionEstrategica(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            abilityId: 'posicion_estrategica',
            abilityName: 'Posición estratégica',
...
function handleEnNombreDelRey(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: 'en_nombre_del_rey',
            abilityName: 'En nombre del rey',
...
function handleMeditacion(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: 'meditacion',
            abilityName: 'Meditación',
...
function handleSacrificar(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: 'sacrificar',
            abilityName: 'Sacrificar',
            targetId: action.targetId,
            targetClass: target.class,
            hit: true,
            damage: 2,
            ...
            difficulty: 0,
            sourceClass: unit.class,
            sourceIdentity: state.players[unit.owner]?.selectedIdentity ?? '',
            details: `General recupera ${allyDied ? '5' : '3'} HP`,
            paCost: 1,
        }],
        nextHistoryId: s.nextHistoryId + 1,
    };
...
function handleAngelGuardian(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: 'angel_guardian',
            abilityName: 'Ángel Guardián',
...
function handleAccionEvasiva(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: 'accion_evasiva',
            abilityName: 'Acción evasiva',
            sourceClass: unit.class,
...
function handleCabalgar2(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: isALaCarga ? 'a_la_carga' : 'cabalgar',
            abilityName: isALaCarga ? 'A la carga' : 'Cabalgar',
            sourceClass: unit.class,
            details: pathStr,
...
function handleTorbellino(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: 'torbellino',
            abilityName: 'Torbellino',
            sourceClass: unit.class,
            sourceIdentity: state.players[unit.owner]?.selectedIdentity ?? '',
            hit,
            damage: hitEnemies,
            ...
            difficulty: 6,
            die1: 0, die2: 0,
            details: hitAllies > 0 ? `Daño a aliados: ${hitAllies}` : undefined,
            modifiers: [],
            paCost: 3,
        }],
        nextHistoryId: s.nextHistoryId + 1,
...
function storeAttackResult(result: AttackResult, attackerId: string, targetId: string, attackerClass: string, targetClass: string, attackName?: string, paCost?: number, paModifiers?: string[]): GameState {
    ...
    const targetKilled = !!s.graveyard[targetId];
    return {
        ...s,
        lastAttackResult: {
            attackerId,
        ...
        gameHistory: [...s.gameHistory, {
            ...
            type: 'ability' as const,
            abilityId: attackName?.toLowerCase().replace(/\s+/g, '_').replace(/[^a-z0-9_]/g, '') ?? 'ability_attack',
            abilityName: attackName ?? 'Ataque básico',
            sourceClass: attackerClass,
            targetId,
            targetClass,
            hit: result.hit,
            damage: result.damage,
...
function handleRayoCelestial(state: GameState, unit: Unit, action: GameAction): GameState {
    ...
    s = {
        ...
        gameHistory: [...s.gameHistory, {
            ...
            playerId: unit.owner,
            type: 'ability' as const,
            abilityId: 'rayo_celestial',
            abilityName: 'Rayo celestial',
            targetId: action.targetId,
            targetClass: target.class,
