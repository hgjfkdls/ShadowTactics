export const es = {
  ...
  ability: {
    ...
    anti_caballeria: { name: 'Anti-caballería', desc: 'Al atacar caballería con ataque básico, +1 daño' },
    formacion_defensiva: { name: 'Formación defensiva', desc: 'Anula el bono de Carga' },
  ...
  card: {
    ...
    ataque_extra: { name: 'Ataque extra', desc: 'Reinicia el ataque básico de una unidad aliada. El siguiente ataque básico no cuesta PA, tiene +1 de daño y +2 de dificultad. Los bonos se consumen al atacar (acierte o no). Si usa una habilidad, los bonos no se aplican.', effectLabel: '+1 ataque, +2 dificultad, 0 PA' },
    flechas_fuego: { name: 'Flechas de fuego', desc: 'El siguiente ataque del jugador inflige +1 de daño. Además, el objetivo recibe 1 de daño pasivo al inicio de los 2 siguientes turnos del jugador.', effectLabel: '+1 daño, daño pasivo 2 turnos' },
